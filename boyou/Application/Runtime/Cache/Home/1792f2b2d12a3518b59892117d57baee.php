    ...
    <div class="product-main cl sevice">
        <div class="g-width main cl">
            ...
            <div class="daohang">
                ...
                <a href="/seoweb/boyou/index.php?s=/Home/Service" class="active">售后服务</a>
            </div>
            <div class="aside">
                <dl>
                    <dt>
            ...
            <div class="sevice-content g-module">
                <h4>
                    售后服务范围
                    <span>(包含工单数换算标准)</span>
                </h4>
                ...
                <div class="sev-package">
                    <div class="package-1 cl package">
                        <img src="/seoweb/boyou/Public/images/icon31.png" alt="">
                        <div class="price-box">
                            <p>180个工单</p>
                            <p class="price">32800元/年</p>
                            <p>包含软件同版本免费升级服务,更换版本8.5折优惠</p>
                        </div>
                    </div>
                    <div class="package-2 cl package">
                        <img src="/seoweb/boyou/Public/images/icon32.png" alt="">
                        <div class="price-box">
                            <p>120个工单</p>
                            <p class="price">22800元/年</p>
                            <p>包含软件同版本免费升级服务、更换版本9折优惠</p>
                        </div>
                    </div>
                    <div class="package-3 cl package">
                        <img src="/seoweb/boyou/Public/images/icon33.png" alt="">
                        <div class="price-box">
                            <p>60个工单</p>
                            <p class="price">12800元/年</p>
                            <p>包含软件同版本免费升级服务、更换版本9.5折优惠</p>
                        </div>
                    </div>
                </div>
                <h4>
