  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="/boyou/manage.php?s=/Manage/Link/add"> 添加友情链接</a> </li>
        <!-- <li>
    ...
    <script type="text/javascript">
    	$(function(){
    		$('#fen').change(function(){
    			...
    			location.href="/boyou/manage.php?s=/Manage/Link/select1/id/"+i;
    		})
    	})
    </script>
...
$(function(){
	...
	location.href="/boyou/manage.php?s=/Manage/Link/bad/id/"+alias+'/why/'+k;
	})
