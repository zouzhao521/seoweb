    ...
    <div class="product-main cl">
        <div class="g-width main cl">
            ...
            <div class="daohang">
                ...
                <a href="/seoweb/boyou/index.php?s=/Home/ProductSolution" class="active">产品解决方案</a>
            </div>
            <div class="aside">
                <dl>
                    <dt>
            ...
            <?php if(empty($id)): ?><ul>
                <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <img src="/seoweb/boyou/Public/Uploads/<?php echo ($vo["img"]); ?>" alt="">
                        <div class="desc-box">
                   ...
                   <!--  <li>
                        <img src="/seoweb/boyou/Public/images/icon_03.png" alt="">
                        <div class="desc-box">
                            <h5>移动APP购彩版</h5>
                    ...
                    <li>
                        <img src="/seoweb/boyou/Public/images/icon_04.png" alt="">
                        <div class="desc-box">
                            <h5>彩票全网解决方案</h5>
                            <p>测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试</p>
                            <div class="know-more">
                    ...
                    <li>
                        <img src="/seoweb/boyou/Public/images/icon_05.png" alt="">
                        <div class="desc-box">
                            <h5>彩票源码开源合作</h5>
                            <p>测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试</p>
                            <div class="know-more">
